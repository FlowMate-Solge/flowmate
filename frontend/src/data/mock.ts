...
export const aiPresets: QA[] = [
  {
    q: '이번 달 괜찮아?',
    a: '6월 매출은 850만원으로 5월 대비 +12% 성장 중이에요. 흐름은 좋습니다.\n\n다만 6월 25일 임대료 280만원이 빠지면 잔액이 1만원까지 떨어지는 위험 구간이 있어요.\n\n6월 21일 네이버 정산 35만원이 들어오니, 이건 세금통장 대신 운영비로 잡아두시는 걸 권합니다.',
  },
  {
    q: '세금 얼마나 떼놔야 해?',
    a: '이번 달 매출 850만원 기준으로 153만원(매출의 18%)을 세금통장에 따로 빼두세요.\n\n지금 40만원만 있어서 113만원이 부족한 상태예요.\n\n7월 25일 부가세 신고 전까지 확보해두시면 안전합니다.',
  },
  {
    q: '어느 플랫폼에 집중해야 해?',
    a: '네이버 예약이 순익률 96.7%로 가장 좋아요. 수수료가 3.3%로 낮거든요.\n\n반면 아워플레이스는 수수료 12%인데 예약은 22건뿐이라 효율이 떨어집니다.\n\n광고비를 아워플레이스에서 네이버 쪽으로 옮겨보시는 걸 추천해요.',
  },
  {
    q: '투자금은 언제 회수돼?',
    a: '초기 투자 5,000만원 기준으로 약 17.9개월 후, 2027년 상반기에 손익분기점에 도달해요.\n\n월 순수익에서 고정비를 뺀 280만원이 회수에 쓰이는 금액이에요.\n\n여름 성수기 매출이 계획대로면 1~2개월 앞당길 수 있습니다.',
  },
]
