...
export const NEARBY_VENUES: NearbyVenue[] = [
  ...
  { name: '화이트가든 노송동', area: '노송동', distanceKm: 1.3, pricePerHour: 32000, capacity: 14, rating: 4.7, platform: '아워플레이스' },
  ...
  { name: '노트파티룸 객사거리', area: '객사거리', distanceKm: 0.2, pricePerHour: 16000, capacity: 7, rating: 4.2, platform: '스페이스클라우드' },
]
